      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container">
                ...
                <div class="card-body">
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="balcao" name="balcao" placeholder="Escreva o nome do Balcao">
                        </div>
                        <div class="form-group">
                            <label>Nome do Posto de Atendimento</label>
                            <input type="text" class="form-control" id="posto" name="posto" placeholder="Escreva o nome do Posto de Atendimento">
                        </div>
                        <div class="form-group mt-2">
                            <label for="estado"><b>Estado</b></label>

                            <select onchange="" id="estado">
                                <option value="activo">Activo</option>
                                <option value="inactivo">Inactivo</option>
                            </select>

                          
                           <!-- <input type="text" class="form-control" id="estado" name="estado" placeholder="Escreva o Estado"> -->
                        </div>
            ...
            <?php 
               ...
               // $result = $mysqli->query("SELECT * FROM tbl_posto");
               // $sql = ("SELECT * FROM tbl_balcao");
                $sql = ("SELECT tbl_posto.id_posto, tbl_posto.id_prov, tbl_posto.nome_posto, tbl_balcao.id_balcao, tbl_balcao.nome_balcao, tbl_balcao.estado FROM tbl_posto INNER JOIN tbl_balcao on tbl_posto.id_posto=tbl_balcao.id_posto");
            ...
            <table id="tblUser">
                <thead>
                    <th>Id</th>
                    <th>Nome do Balcao</th>
                    <th>Nome do Posto de Atendimento</th>
                    <th>Estado</th>
                    <th>Acção</th>
                </thead>
                <tbody>
                <?php while($user = $result->fetch_assoc()): ?>
                        <tr>
                           <td><?php echo $user['id_balcao']; ?></td>
                            <td><?php echo $user['nome_balcao']; ?></td>
                            <td><?php echo $user['nome_posto']; ?></td>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#submit").on('click',function(e){
            ...
            $.ajax({
                url : "insertdata.php",
                type : "POST",
                data : {balcao:balcao,posto:posto,estado:estado},
