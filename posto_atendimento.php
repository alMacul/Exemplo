...
<div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="container">
                ...
                <div class="card-body">
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="prov_name" name="prov_name" placeholder="Nome da Provincia">
                        </div>
                        <div class="form-group">
                            <label>Nome da Posto de Atendimento</label>
                            <input type="text" class="form-control" id="posto" name="posto" placeholder="Nome do Posto">
                        </div>
            ...
            <?php 
                ...
                $sql = ("SELECT tbl_provincia.nome_prov, tbl_posto.id_posto, tbl_posto.nome_posto, tbl_posto.estado FROM tbl_provincia INNER JOIN tbl_posto ON tbl_provincia.id_prov=tbl_posto.id_prov");
            ...
            <table id="tblUser">
                ...
                <?php while($user = $result->fetch_assoc()): ?>
                        <tr>
                           <td><?php echo ++$key; ?></td>
                           <td><?php echo $user['id_posto']; ?></td>
                            <td><?php echo $user['nome_posto']; ?></td>
                            <td><?php echo $user['nome_prov']; ?></td>
                            <td><?php echo $user['estado']; ?></td>
                            <td>
                            <a href="update_data_form.php?id=<?php echo $user['id_posto']; ?>" class="btn btn-primary btn-sm">Editar</i></a>
                            <a href="delete_data.php?id=<?php echo $user['id_posto']; ?>" class="btn btn-danger btn-sm">Apagar</i></a>
                            </td>
                        </tr>
                <?php endwhile ?>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#submit").on('click',function(e){
            ...
            $.ajax({
                url : "insert_posto.php",
                type : "POST",
                data : {posto:posto,prov_name:prov_name,estado:estado},
